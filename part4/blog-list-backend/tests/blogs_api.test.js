...
describe('when dealing with users in DB', () => {
    ...
    test('creation succeeds with a fresh username satisfying all constraints', async () => {
    ...
    describe('user creation fails with proper code and message when', () => {
